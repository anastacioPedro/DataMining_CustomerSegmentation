...
"""
Drop BirthYear column as 1stYearPolicy is company data so more accurate. Additionally BirthYear is highly correlated 
with GrossMthSalary
"""
...
#Once we handle 1stPolYear then this will work properly
# WE don't have to drop column with geoLivArea for the decission tree but we don't want to multiply sets
...
for index in y_test.index:
    ...
    i+=1
# We chose knn because the avg mistake is smaller

####Replacing missing data [EduDegree] with Decision Tree   #####################################
#Same here, Once we handle previously 1stPolYear then this will work properly
